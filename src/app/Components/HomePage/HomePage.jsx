...
const HomePage = () => {
    return (
        <div className="bg-gray-900 text-white p-10 h-screen flex flex-col justify-center">
            <div className="flex items-center gap-5">
                <div className='flex flex-col gap-6 justify-center items-start md:w-3/5'>
                    <h1 className='text-3xl md:text-4xl font-bold text-white'>
                        Hello, My name is <span className='text-orange-500'>Ashraful Islam</span>
                    </h1>
